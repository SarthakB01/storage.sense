...
//         try {
//             const response = await fetch('/api/files/Convert_docs/wordtopdf_be', {
//                 method: 'POST',
//                 body: formData,
//             });
...
//                 <h1 className="text-2xl font-bold text-gray-800 dark:text-white mb-6">Convert Word to PDF</h1>
...
//                         </div>
//                     ) : (
//                         <p className="text-gray-600 dark:text-gray-400">Drag and drop a WORD file here, or click to select</p>
//                     )}
//                 </div>
...
interface WordToPdfComponentProps {
...
export const WordToPdfComponent: React.FC<WordToPdfComponentProps> = ({ 
    apiEndpoint = '/api/files/Convert_docs/wordtopdf_be',
    acceptedFileTypes = {
        "application/pdf": [],
        "application/msword": [],
        "application/vnd.openxmlformats-officedocument.wordprocessingml.document": [],
...
export default WordToPdfComponent;
